...
namespace BO
{
    public class Parcel
    {
        ...
        {
            return String.Format($"Code Parcel: {CodeParcel}, Sender Customer: {SenderCustomer}, TargetCustomer: {TargetCustomer}, Weight: {Weight}, Priority:{Priority} Drone In Parcel: {DroneInParcel}, Requested: {Requested}, Scheduled: {Scheduled}, PickedUp: {PickedUp}, Delivered: {Delivered}");
        }
    }
}
